      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 w-full max-w-sm">
        ...
        <div className="flex flex-col items-center mb-6">
          <img
            ...
            alt="GoGarage"
            className="h-20 w-20 object-contain rounded-xl shadow-sm mb-3"
          />
          <h1 className="text-2xl font-bold tracking-tight text-gray-800">Create Account</h1>
          <p className="text-sm text-gray-400 mt-1">Join GoGarage today</p>
        </div>
        ...
        <p className="text-sm text-center mt-6 text-gray-500">
          ...
          <Link to="/login" className="text-blue-600 font-medium hover:text-blue-700 transition-colors duration-200">
            Log in
          </Link>
        </p>
      </div>
